  ...
  return (
    <div className=" p-10 w-[98vw]  ml-2">
      <div className="flex flex-col items-center md:flex-row w-full justify-between gap-8 ">
        <div className="w-[100%] md:w-[50%] bg-slate-200 shadow-lg cursor-pointer hover:scale-105 transition-all duration-300 ease-out min-h-[400px] text-center  p-4 rounded-lg">
        ...
        <div className="w-[100%] md:w-[50%] bg-slate-200 shadow-lg cursor-pointer hover:scale-105 transition-all duration-300 ease-out min-h-[400px] text-center  p-4 rounded-lg">
          ...
          <div className="mt-10 flex flex-col gap-4  text-xl">
            <div className="flex gap-2 items-center p-4 border-[1px] rounded-lg border-green-600 ">
