...
const Navbar = () => {
  const Styles = {
    ...
    nav_items:
      "flex gap-1 cursor-pointer font-semibold items-center justify-center hover:text-gray-400",
    nav_dropdown:
      "flex flex-col absolute gap-2 p-2 justify-center items-center bg-white text-black border-[1px] rounded-lg ",
  ...
  return (
    <div className="bg-black/70 md:text-white sticky top-0 z-10">
